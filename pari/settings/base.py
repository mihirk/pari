...
ADMIN_MENU_ORDER = (
    (_("Content"), ("pages.Page", "article.Article", "article.Author", "article.Location", "article.Category", "article.Type",
       "album.Album", "resources.Resource", "resources.Factoid", "contribution.Contribution",
