...
var Dajaxice = {
    ...
    search_filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('pari.article.search_filter', 'POST', callback_function, argv, custom_settings);
    },

    category_article_filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('pari.article.category_article_filter', 'POST', callback_function, argv, custom_settings);
    },

    archive_article_filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('pari.article.archive_article_filter', 'POST', callback_function, argv, custom_settings);
    },

    keyword_article_filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('pari.article.keyword_article_filter', 'POST', callback_function, argv, custom_settings);
    },

    author_article_filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('pari.article.author_article_filter', 'POST', callback_function, argv, custom_settings);
    },

    location_article_filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('pari.article.location_article_filter', 'POST', callback_function, argv, custom_settings);
    },

    all_article_filter: function(callback_function, argv, custom_settings){
        return Dajaxice.call('pari.article.all_article_filter', 'POST', callback_function, argv, custom_settings);
    }
